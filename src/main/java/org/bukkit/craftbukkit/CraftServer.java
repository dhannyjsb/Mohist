...
public final class CraftServer implements Server {
    ...
    public String getBukkitVersion() {
        return Mohist.getBukkitVersion();
    }
    ...
    @Override
    public void reload() {
        if (true) return; // Mohist - disable reload
        reloadCount++;
        configuration = YamlConfiguration.loadConfiguration(getConfigFile());
        commandsConfiguration = YamlConfiguration.loadConfiguration(getCommandsConfigFile());
        ...
        MohistConfig.init((File) console.options.valueOf("mohist-settings")); // Mohist
        ...
        for (WorldServer world : console.worlds) {
            ...
            world.pfserverConfig.init(); // Mohist
    ...
    public String toString() {
        return "CraftServer{" + "serverName=" + Mohist.getName() + ",serverVersion=" + serverVersion + ",minecraftVersion=" + console.getMinecraftVersion() + '}';
    }
