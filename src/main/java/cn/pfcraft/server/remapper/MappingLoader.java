...
public class MappingLoader {
    ...
    private static void loadNmsMappings(JarMapping jarMapping, String obfVersion) throws IOException {
        ...
        jarMapping.loadMappings(new BufferedReader(new InputStreamReader(MappingLoader.class.getClassLoader().getResourceAsStream("mappings/" + obfVersion + "/cb2srg.srg"))), new MavenShade(relocations), null, false);
       }
    ...
    public static JarMapping loadMapping() {
        ...
        try {
            ...
            loadNmsMappings(jarMapping, Mohist.getNativeVersion());
