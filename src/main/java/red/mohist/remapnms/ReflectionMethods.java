...
public class ReflectionMethods {
    ...
    public static Class<?> forName(String className) throws ClassNotFoundException {
        return forName(className, true, MohistRemapUtils.getCallerClassloader());
    }

    public static Class<?> forName(String className, boolean initialize, ClassLoader classLoader) throws ClassNotFoundException {
        if (!className.startsWith("net.minecraft.server." + Mohist.getNativeVersion())) return Class.forName(className, initialize, classLoader);
    ...
    public static Field getField(Class<?> inst, String name) throws NoSuchFieldException, SecurityException {
        ...
        return inst.getField(ReflectionTransformer.remapper.mapFieldName(MohistRemapUtils.reverseMap(inst), name, null));
    }
    ...
    public static Field getDeclaredField(Class<?> inst, String name) throws NoSuchFieldException, SecurityException {
        ...
        return inst.getDeclaredField(ReflectionTransformer.remapper.mapFieldName(MohistRemapUtils.reverseMap(inst), name, null));
    }
    ...
    public static Method getMethod(Class<?> inst, String name, Class<?>...parameterTypes) throws NoSuchMethodException, SecurityException {
        ...
        return inst.getMethod(MohistRemapUtils.mapMethod(inst, name, parameterTypes), parameterTypes);
    }
    ...
    public static Method getDeclaredMethod(Class<?> inst, String name, Class<?>...parameterTypes) throws NoSuchMethodException, SecurityException {
        ...
        return inst.getDeclaredMethod(MohistRemapUtils.mapMethod(inst, name, parameterTypes), parameterTypes);
    }
    ...
    public static String getName(Field field) {
        ...
        String retn = MohistRemapUtils.demapFieldName(field);
    ...
    public static String getName(Method method) {
        ...
        if (cache != null) return cache;
        String retn = MohistRemapUtils.demapMethodName(method);
    ...
    public static String getSimpleName(Class<?> inst) {
        ...
        if (cache != null) return cache;
        String[] name = MohistRemapUtils.reverseMapExternal(inst).split("\\.");
    ...
    public static Class<?> loadClass(ClassLoader inst, String className) throws ClassNotFoundException {
        if (className.startsWith("net.minecraft."))
            className = MohistRemapUtils.mapClass(className.replace('.', '/')).replace('/', '.');
